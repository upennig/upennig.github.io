...
My research focuses on connections between operator algebras and algebraic topology, in particular (twisted) K-theory and index theory. An important example is topological K-theory, a generalised cohomology theory that can be defined via the algebra of continuous functions on a space and generalised to noncommutative algebras — objects that play an important role in mathematical physics and can describe highly singular topological spaces, such as orbifolds or foliations. K-theory has many variants, including equivariant and twisted K-theory; one outcome of my research, joint with [Marius Dadarlat](http://www.math.purdue.edu/~mdd/), was a description of twisted K-theory via operator algebras that includes the higher twists — a feature of the theory previously only accessible via homotopy theory. Having studied mathematical physics before my PhD, I am also interested in topological and conformal field theories and their connection with elliptic cohomology.
