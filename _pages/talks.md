...
- *Bundles of C\*-Algebras and Higher Dixmier-Douady Theory*, Non-commutative Geometry along the North Sea, Lorentz Center, Leiden (Jun)
- *Equivariant Higher Dixmier-Douady Theory for Circle Actions*, Oberseminar Global Analysis and Geometry, Regensburg (Feb) - [slides](/assets/pdf/regensburg.pdf)
- *Equivariant higher twists over SU(n)*, Oberseminar Topologie, Göttingen (Jan)

**2021:**

- *Exponential Functor Twists for K-theory over SU(n)*, University of Aberdeen (Nov)
...
- *Loops, Groups and Twists - the role of K-theory in mathematical physics*, Pure Maths Colloquium, Southampton (Oct) - [slides](/assets/pdf/loops_groups_and_twists.pdf)
- *Equivariant higher twisted K-theory of SU(n) via exponential functors*, Topology Seminar, Sheffield (Oct)
- *Equivariant higher twisted K-theory of SU(n) via exponential functors*, Operator Algebra Seminar, Glasgow (Oct)
- *Equivariant higher twisted K-theory of SU(n) via exponential functors*, [34th British Topology Meeting](https://sites.google.com/view/btm34), Warwick (Sep)
- *Equivariant higher twisted K-theory of SU(n) via exponential functors*, Operator Algebras and Quantum Physics, Simons Center, New York (Jun)
...
- *A Dixmier-Douady Theory for strongly self-absorbing C\*-algebras*, Kyoto Operator Algebra Seminar (Jan)
...
- *Unit Spectra of K-theory via strongly self-absorbing C\*-algebras*, 101st Meeting of the Transpennine Topology Triangle, Leicester (Nov)
- *Twisted index obstructions to positive scalar curvature*, Analysis Seminar, Loughborough (Nov)
- *Higher twisted K-theory via strongly self-absorbing C\*-algebras*, Algebra and Topology Seminar, Swansea (Oct)
- *A non-commutative model for higher twisted K-theory*, [31st Summer Conference on Topology and its Applications](https://sites.google.com/site/summertopology/home), Leicester (Aug) - [slides](/assets/pdf/highertwisted.pdf)
- *Deformations of nilpotent groups and homotopy symmetric C\*-algebras*, Wabash Analysis Seminar (Apr)
- *Deformations of nilpotent groups and homotopy symmetric C\*-algebras*, Analysis Seminar, Glasgow (Mar)
- *Higher twisted K-theory via strongly self-absorbing C\*-algebras*, Topology Seminar, Aberdeen (Mar)
...
- *Higher Twisted K-theory*, Strings and Automorphic Forms in Topology, Bochum (Aug)
- *Higher Twisted K-theory*, Young Topologists Meeting 2012, Copenhagen (Jun)
- *Twisted 2-vector bundles*, 17th NRW Topology, Münster (May)
